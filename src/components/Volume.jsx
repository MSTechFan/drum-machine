...
const Volume = () => {
  ...
  return (
    <div className="volume" style={styles}>
        <input ref={range} type="range" min="0" max="100" value="50" className="volume-range" onChange={(event) => handleRangeChange(event.target.value)}/>
        ...
        <div ref={barHoverBox} className="bar-hoverbox" onTouchStart={"use"} onTouchMove={"use"} onMouseDown={"use"} onMouseMove={"use"} onWheel={"use"}>
          <div className="bar">
