...
import volumeScript from './volumeScript.js'
...
const Volume = () => {
  ...
  return (
    <div className="volume" style={styles}>
        <input ref={range} type="range" min="0" max="100" value="50" className="volume-range" onChange={(event)=>this.inputChangedHandler(event)}/>
