...
const Volume = () => {
  ...
  return (
    <div className="volume" style={styles}>
        ...
        <input type="range" min="0" max="100" value={range} className="volume-range" onChange={(event) => console.log(event.target.value)}/>
        <div className="bar-hoverbox" 
        onTouchStart={(event) => console.log(event)} onTouchMove={""} onMouseDown={""} onMouseMove={""} 
